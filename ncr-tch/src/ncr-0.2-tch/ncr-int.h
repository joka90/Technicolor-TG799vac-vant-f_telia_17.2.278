...
/* key import */
int ncr_key_import_from_kernel(struct ncr_lists *lst, const struct key_item_st *item_import, char *key_data, const unsigned int key_size);
...
void ncr_master_key_set_internal(void);
/* storage */
