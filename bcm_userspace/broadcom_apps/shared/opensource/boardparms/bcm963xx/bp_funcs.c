...
int BpGetEthLedMap_tch( unsigned long *pulValue)
{
    return( BpGetUl( bp_ulEthLedMap_tch, pulValue ));
}
...
/**************************************************************************
* Name       : BpGetGpioIntAFELDMode_tch
*
* Description: Indicates if the board has wrong ADSL/VDSL gpio pinning used.
*              Will only be used to fix VDNT-W and variants.
*
* Parameters : [OUT] pusValue - Address of short word that the
*                  gpio number is returned in.
*
...
*
***************************************************************************/
BpGetGpioIntAFELDMode_tch( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioIntAFELDMode_tch, pusValue ) );
} /* BpGetGpioIntAFELDMode_tch */
