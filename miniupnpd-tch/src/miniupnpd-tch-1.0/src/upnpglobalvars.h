...
/* default name of the network interface used to acces internet */
extern const char * ext_if_name_default;
...
#define UPNP_WGCLP_SCRIPT_LEN (64)
extern char upnp_wgclp[];
...
/* external interface rules list */
extern struct extiface_rule_list extiface_rules;
