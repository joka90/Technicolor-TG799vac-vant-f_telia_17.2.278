                 ...
                 const char * uuidvalue, unsigned int delay)
{
	...
	l = snprintf(buf, sizeof(buf), "HTTP/1.1 200 OK\r\n"
		...
		"LOCATION: http://%s:%u%s\r\n"
		"SECURELOCATION.UPNP.ORG: https://%s:%u%s\r\n"
		"\r\n",
		...
		host, (unsigned int)http_port, ROOTDESC_PATH
		, host, (unsigned int)https_port, ROOTDESC_PATH
		);
	if(l<0)
	{
...
} const known_service_types[] =
{
    ...
    {"urn:dslforum-org:device:InternetGatewayDevice:", 1, uuidvalue_igd},
//    {"urn:dslforum-org:service:Layer3Forwarding:", 1, uuidvalue_igd},
    {"urn:dslforum-org:service:DeviceInfo:", 1, uuidvalue_igd},
    {"urn:dslforum-org:service:DeviceConfig:", 1, uuidvalue_igd},
    {"urn:dslforum-org:service:LANConfigSecurity:", 1, uuidvalue_igd},
//    {"urn:dslforum-org:service:ManagementServer:", 1, uuidvalue_igd},
//    {"urn:dslforum-org:device:LANDevice:", 1, uuidvalue_lan},
//    {"urn:dslforum-org:service:LANHostConfigMgmt:", 1, uuidvalue_lan},
//    {"urn:dslforum-org:service:LANEthernetInterfaceConfig:", 1, uuidvalue_lan},
//    {"urn:dslforum-org:service:WLANConfiguration:", 1, uuidvalue_lan},
//    {"urn:dslforum-org:device:WANDevice:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:service:WANCommonInterfaceConfig:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:service:WANDSLInterfaceConfig:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:service:WANEthernetInterfaceConfig:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:service:WANDSLConnectionManagement:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:service:WANDSLDiagnostics:", 1, uuidvalue_wan},
//    {"urn:dslforum-org:device:WANConnectionDevice:", 1, uuidvalue_wcd},
//    {"urn:dslforum-org:service:WANDSLLinkConfig:", 1, uuidvalue_wcd},
//    {"urn:dslforum-org:service:WANEthernetLinkConfig:", 1, uuidvalue_wcd},
//    {"urn:dslforum-org:service:WANIPConnection:", 1, uuidvalue_wcd},
//    {"urn:dslforum-org:service:WANPPPConnection:", 1, uuidvalue_wcd},
	{0, 0, 0}
};
               ...
               unsigned int lifetime)
{
	...
	l = snprintf(bufr, sizeof(bufr),
		...
		host, (unsigned int)http_port, ROOTDESC_PATH,	/* LOCATION: */
		host, (unsigned int)https_port, ROOTDESC_PATH,	/* SECURE-LOCATION: */
		nt, suffix,						/* NT: */
	...
	else if(memcmp(bufr, "M-SEARCH", 8) == 0)
	{
		...
		/* only answer for service version lower or equal of supported one */
				   ...
				   )
				{
					 ...
					 * and “urn:dslforum-org:service:xyz:1”. The response
	...
	for(j=0; j<n_sockets; j++)
	{
	    ...
	    for(i=0; known_service_types[i].s; i++)
	    {
			...
			ret += SendSSDPbyebye(sockets[j],
			                      ...
			                      known_service_types[i].s); /* ver_str, USN: */
			if(0==memcmp(known_service_types[i].s,
			             "urn:dslforum-org:device", sizeof("urn:dslforum-org:device")-1))
			{
				ret += SendSSDPbyebye(sockets[j],
#ifdef ENABLE_IPV6
				                      sockname, socknamelen,
 ...
 * register services offered by MiniTR064d to a running instance of
 * MiniSSDPd */
int
SubmitServicesToMiniSSDPD(const char * host, unsigned short port) {
	...
	for(i = 0; known_service_types[i].s; i++) {
		...
		memcpy(p, strbuf, l);
		p += l;
		l = (int)strlen(MINITR064D_SERVER_STRING);
		CODELENGTH(l, p);
		memcpy(p, MINITR064D_SERVER_STRING, l);
		p += l;
